            ...
            <div className='CityMapParam'>
                ...
                <fieldset >
                    ...
                    <label>{GetLocaleString("citymap.latitude")}
                        <input ref={focusref} type="number" value={editLatitude} step="0.0001" min="-90" max="90" className='textedit'
                            onChange={(e) => setLatitude(e.target.value)} />
                    </label>
                    <label>{GetLocaleString("citymap.longitude")}
                        <input type="number" value={editLongitude} step="0.0001" min="-180" max="180" className='textedit'
                            onChange={(e) => setLongitude(e.target.value)} />
                    </label>
                    <label>{GetLocaleString("citymap.radius")}
                        <input type="number" value={radius} onChange={(e) => setRadius(e.target.value)} min={40} max={1500} className='textedit'/>
                    </label>
